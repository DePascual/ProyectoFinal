    ...
    .controller('userCtrl', function ($scope, $http, $compile, $window, $location) {
        ...
        if (sessionStorage.getItem("infoUsuario") != null) {
            ...
            if (dropUsuActivo == "false") {
                ...
                $('#dropUsu').append('<a id="dynamic" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" style="color:#0079ff; font-weight:bold">' + usuSession.Username + '<span class="caret"></span></a>'
